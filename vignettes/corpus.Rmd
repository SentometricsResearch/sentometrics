...
A `sento_corpus` object is special because it always has numeric metadata features. Using the `add_features()` function, additional features can be added, or generated through keywords or regex pattern matching.
