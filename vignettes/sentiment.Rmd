...
The same simple calculation as above, but using a `sento_corpus` object and the metadata features in the corpus.
...
compute_sentiment(corpus, lexicons, how = "counts", tokens = tks)
```
