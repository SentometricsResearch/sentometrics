...
Overview of anticipated developments and known bugs or unfinished business. If you want to help out on one of these things, contact the maintainer.
...
- Be more flexible for the features in a `sento_corpus` object by allowing also values outside 0 and 1.

- Make sure subsetting does not maintain a `sentiment` object when it is not supposed to be.

- Drop horizontal 0-line for the `plot.sento_measures()` function as it distorts graphs of time series with values far away from 0.
