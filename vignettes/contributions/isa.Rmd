...
Earlier, we implemented the *bins* approach by creating equal-sized containers of words. Each *bin* then contained a similar number of words. This naive split had the effect of splitting some sentences across two *bins*. From a semantic point of view, this not desirable. Hence, we need to define a new *bins* approach that respects the integrity of the sentences: quite simply, *bins* of sentences.
