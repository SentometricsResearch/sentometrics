...
load("nonpackage/example (tm package)/corpus.rda")
load("nonpackage/example (tm package)/negativeDiction_McDonald.rda")
load("nonpackage/example (tm package)/positiveDiction_McDonald.rda")
...
# The number appearing in each row of one of the topic columns is the probability that the document is from that topic.
