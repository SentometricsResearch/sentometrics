...
See the [project page](https://sborms.github.io/sentometrics/), the [vignette](https://doi.org/10.2139/ssrn.3067734) and following [paper](https://doi.org/10.1016/j.ijforecast.2018.10.010) for respectively a brief and an extensive introduction to the package, and a real-life macroeconomic forecasting application. We refer also to this [survey](https://doi.org/10.2139/ssrn.2652876) for an overview of workflow in a typical econometric analysis of sentiment from alternative (such as textual) data.
