...
source("SHINY (BELGA)/sourceall.R")
...
###### (combine and) convert all input xml files to one data.frame

# data_folder <- "SHINY (BELGA)/data/"
...
# save(xmldt16old, file = "SHINY (BELGA)/data/xmldt16old.rda")

xmldt16 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2016.xml", stringsAsFactors = FALSE)
save(xmldt16, file = "SHINY (BELGA)/data/xmldt16.rda")

xmldt15 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2015.xml", stringsAsFactors = FALSE)
save(xmldt15, file = "SHINY (BELGA)/data/xmldt15.rda")

xmldt14 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2014.xml", stringsAsFactors = FALSE)
save(xmldt14, file = "SHINY (BELGA)/data/xmldt14.rda")

xmldt13 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2013.xml", stringsAsFactors = FALSE)
save(xmldt13, file = "SHINY (BELGA)/data/xmldt13.rda")

xmldt12 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2012.xml", stringsAsFactors = FALSE)
save(xmldt12, file = "SHINY (BELGA)/data/mldt12.rda")

xmldt11 <- xmlToDataFrame("SHINY (BELGA)/data/text/360texts-2011.xml", stringsAsFactors = FALSE)
save(xmldt11, file = "SHINY (BELGA)/data/xmldt11.rda")

xmldt10 <- xmlToDataFrame("SHINY (BELGA)/data/360texts-2010.xml", stringsAsFactors = FALSE)
save(xmldt10, file = "SHINY (BELGA)/data/xmldt10.rda")

load("SHINY (BELGA)/data/xmldt.rda") # 2016
load("SHINY (BELGA)/data/xmldt16.rda") # doesn't have body and lead (are empty strings), thus matched above
load("SHINY (BELGA)/data/xmldt15.rda")
load("SHINY (BELGA)/data/xmldt14.rda")
load("SHINY (BELGA)/data/xmldt13.rda")
load("SHINY (BELGA)/data/xmldt12.rda")
load("SHINY (BELGA)/data/xmldt11.rda")
load("SHINY (BELGA)/data/xmldt10.rda")
...
# corpusOld <- corpus
# save(corpusOld, file = "SHINY (BELGA)/data/corpusOld.rda")
...
# save(corpusNew, file = "SHINY (BELGA)/data/corpusNew.rda")

# load("SHINY (BELGA)/data/corpusOld.rda")
# load("SHINY (BELGA)/data/corpusNew.rda")
...
# save(corpusFull, file = "SHINY (BELGA)/data/corpusFull.rda")

load("SHINY (BELGA)/data/corpusFull.rda")
...
# save(lexicons, file = "SHINY (BELGA)/data/lexicons.rda")
# save(valences, file = "SHINY (BELGA)/data/valences.rda")

load("SHINY (BELGA)/data/lexicons.rda")
load("SHINY (BELGA)/data/valences.rda")
...
to_quanteda_dfm <- function(corp) {
  ...
  dfm <- quanteda::dfm(quanteda::tokenize(c,
...
dfmFOOT_fr <- to_quanteda_dfm(corpusFOOTall$fr); save(dfmFOOT_fr, file = "SHINY (BELGA)/data/dfmFOOT_fr.rda")
dfmFOOT_nl <- to_quanteda_dfm(corpusFOOTall$nl); save(dfmFOOT_nl, file = "SHINY (BELGA)/data/dfmFOOT_nl.rda")
dfmTER_fr <- to_quanteda_dfm(corpusTERall$fr); save(dfmTER_fr, file = "SHINY (BELGA)/data/dfmTER_fr.rda")
dfmTER_nl <- to_quanteda_dfm(corpusTERall$nl); save(dfmTER_nl, file = "SHINY (BELGA)/data/dfmdfmTER_nl.rda")
dfmFIN_fr <- to_quanteda_dfm(corpusFINall$fr); save(dfmFIN_fr, file = "SHINY (BELGA)/data/dfmFIN_fr.rda")
dfmFIN_nl <- to_quanteda_dfm(corpusFINall$nl); save(dfmFIN_nl, file = "SHINY (BELGA)/data/dfmFIN_nl.rda")
dfmECO_fr <- to_quanteda_dfm(corpusECOall$fr); save(dfmECO_fr, file = "SHINY (BELGA)/data/dfmECO_fr.rda")
dfmECO_nl <- to_quanteda_dfm(corpusECOall$nl); save(dfmECO_nl, file = "SHINY (BELGA)/data/dfmECO_nlr.rda")
dfmPOL_fr <- to_quanteda_dfm(corpusPOLall$fr); save(dfmPOL_fr, file = "SHINY (BELGA)/data/dfmPOL_fr.rda")
dfmPOL_nl <- to_quanteda_dfm(corpusPOLall$nl); save(dfmPOL_nl, file = "SHINY (BELGA)/data/dfmPOL_nl.rda")

load("SHINY (BELGA)/data/dfmFOOT_fr.rda")
load("SHINY (BELGA)/data/dfmFOOT_nl.rda")
load("SHINY (BELGA)/data/dfmTER_fr.rda")
load("SHINY (BELGA)/data/dfmdfmTER_nl.rda")
load("SHINY (BELGA)/data/dfmFIN_fr.rda")
load("SHINY (BELGA)/data/dfmFIN_nl.rda")
load("SHINY (BELGA)/data/dfmECO_fr.rda")
load("SHINY (BELGA)/data/dfmECO_nlr.rda")
load("SHINY (BELGA)/data/dfmPOL_fr.rda")
load("SHINY (BELGA)/data/dfmPOL_nl.rda")
...
sentimentr_simple <- function(texts, lexicon) {
  ...
  dt[, 'words' := list(make_words(space_fill(docs, space_words)))] # slow part (could be stored as an object and passed as an argument)
...
save(foot, file = "SHINY (BELGA)/foot.rda")
...
save(ter, file = "SHINY (BELGA)/ter.rda")
...
save(fin, file = "SHINY (BELGA)/fin.rda")
...
save(eco, file = "SHINY (BELGA)/eco.rda")
...
save(pol, file = "SHINY (BELGA)/pol.rda")

load("SHINY (BELGA)/foot.rda")
load("SHINY (BELGA)/ter.rda")
load("SHINY (BELGA)/fin.rda")
load("SHINY (BELGA)/eco.rda")
load("SHINY (BELGA)/pol.rda")

comb <- c(foot, ter, fin, eco, pol)
outTmp <- rbindlist(comb, use.names = TRUE)
out <- outTmp

save(out, file = "SHINY (BELGA)/sentimentShinyAll.rda")
load("SHINY (BELGA)/sentimentShinyAll.rda")
...
save(foot2, file = "SHINY (BELGA)/foot2.rda")
...
save(ter2, file = "SHINY (BELGA)/ter2.rda")
...
save(fin2, file = "SHINY (BELGA)/fin2.rda")
...
save(eco2, file = "SHINY (BELGA)/eco2.rda")
...
save(pol2, file = "SHINY (BELGA)/pol2.rda")

load("SHINY (BELGA)/foot2.rda")
load("SHINY (BELGA)/ter2.rda")
load("SHINY (BELGA)/fin2.rda")
load("SHINY (BELGA)/eco2.rda")
load("SHINY (BELGA)/pol2.rda")

comb2 <- c(foot2, ter2, fin2, eco2, pol2)
outTmp <- rbindlist(comb2, use.names = TRUE)
out <- outTmp

save(out, file = "SHINY (BELGA)/sentimentShinyAll2.rda")
load("SHINY (BELGA)/sentimentShinyAll2.rda")
...
save(out, file = "SHINY (BELGA)/sentimentShinyAll3.rda")
